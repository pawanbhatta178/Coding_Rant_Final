...
const Home = () => {
  return (
    <div className="grid-home max-w bg-primary text-primary">
      <div></div>
      <div>
        <NavBar />
        <div className="flex flex-col px-4 sm:px-6 md:px-8 pb-12 h-full">
          ...
          <p className="max-w-screen-lg text-lg sm:text-2xl sm:leading-10 font-medium mb-10 sm:mb-11 text-secondary">
            With our hand picked coding challenges, you not only will be ready
            for coding interviews but also gain deeper insight on how{" "}
