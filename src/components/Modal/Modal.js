...
const Modal = ({ show, onClose, children }) => {
  ...
  return (
    show && (
      <>
        <div className="z-20 absolute top-1/2 left-1/2 bg-primary text-primary transform -translate-x-1/2 -translate-y-1/2 border-t-2 border-accent rounded-md px-4 py-4">
